...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link rel="stylesheet" href="{{ asset('startbootstrap-sb-admin-2/vendor/metisMenu/metisMenu.css') }} ">

    <!-- Custom CSS -->
    <link href="{{ asset('startbootstrap-sb-admin-2/dist/css/sb-admin-2.css') }} " rel="stylesheet">

    <!-- Morris Charts CSS -->
    <!-- <link rel="stylesheet" href="{{ asset('startbootstrap-sb-admin-2/vendor/morrisjs/morris.css') }} "> -->
...
<body>
    ...
    <div id="wrapper" ng-app="logistic" ng-controller="RootController">
    ...
    <script src="{{ asset('bower_components/bootstrap/dist/js/bootstrap.js') }} "></script>
      <script src="{{ asset('startbootstrap-sb-admin-2/vendor/metisMenu/metisMenu.js') }} "></script>  
    ...
    <!-- <script src="{{ asset('startbootstrap-sb-admin-2/data/morris-data.js') }} "></script> -->
     <script src="{{ asset('startbootstrap-sb-admin-2/dist/js/sb-admin-2.js') }} "></script> 
