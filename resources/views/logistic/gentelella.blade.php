...
<head>
  ...
  <!-- Bootstrap -->
  <link rel="stylesheet" href="{{ asset('bower_components/gentelella/vendors/bootstrap/dist/css/bootstrap.min.css') }} ">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{ asset('bower_components/gentelella/vendors/font-awesome/css/font-awesome.min.css') }} ">
  <!-- NProgress -->
  <link rel="stylesheet" href="{{ asset('bower_components/gentelella/vendors/nprogress/nprogress.css') }} ">
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('bower_components/gentelella/vendors/iCheck/skins/flat/green.css') }} ">
  <!-- bootstrap-progressbar -->
  <link rel="stylesheet" href="{{ asset('bower_components/gentelella/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css') }} ">
  <!-- JQVMap -->
  <link rel="stylesheet" href="{{ asset('bower_components/gentelella/vendors/jqvmap/dist/jqvmap.min.css') }} ">
  <!-- bootstrap-daterangepicker -->
  <link rel="stylesheet" href="{{ asset('bower_components/gentelella/vendors/bootstrap-daterangepicker/daterangepicker.css') }} ">
  <!-- Custom Theme Style -->
  <link rel="stylesheet" href="{{ asset('bower_components/gentelella/build/css/custom.min.css') }} "> {{-- head --}}
  ...
  <base href="{{ url('/') }}/logistic/gentelella/">
...
<body class="nav-md">
        ...
        <div class="left_col scroll-view">
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                <a href="{{ asset('/logistic/gentelella') }} "><h3><i class="fa fa-home"></i> Principal</h3></a>
            </div>
            <div class="menu_section">
              <h3>Logistica</h3>
              <ul class="nav side-menu">
                @foreach (config('logistic.menu') as $name => $section)
                <li><a>{{$name}} <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li>
                      <div class="block">
                        <div class="block_content">
                          ...
                          <p class="excerpt">Film festivals used to be do-or-die moments for movie makers. They were where you met the producers
                            that could fund your project, and if the buyers liked your flick, they’d pay to Fast-forward
                            and… <a>Read&nbsp;More</a>
                          </p>
                        </div>
                      </div>
  ...
  <script>
    ...
    const GLOBALS = function () {
      return {
        url: "{{ url('/') }}",
        app_url: "{{ url('/') }}/logistic/gentelella",
