            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" ng-model="registro.brands_detail" type="text" ng-keyup="brands.get($event.keyCode, registro.brands_detail)" placeholder="Buscar con [ctrl]">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" ng-model="registro.categories_detail" type="text" ng-keyup="categories.get($event.keyCode, registro.categories_detail)" placeholder="Buscar con [ctrl]">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" ng-model="registro.measurements_detail" type="text" ng-keyup="measurements.get($event.keyCode, registro.measurements_detail)" placeholder="Buscar con [ctrl]">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" ng-model="registro.packings_detail" type="text" ng-keyup="packings.get($event.keyCode, registro.packings_detail)" placeholder="Buscar con [ctrl]">
